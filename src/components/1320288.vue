  ...
  <v-container>
    <v-form ref="updateForm">
      ...
      <v-row>
        ...
        <v-col md="2">
          <v-text-field type="number" label="场地费标准(含税)" v-model="placeUseContractItem.price"
                        readonly></v-text-field>
        </v-col>
        <v-col md="2">
          <v-text-field type="number" label="场地费总额(含税)" v-model="placeUseContractItem.money"
                        readonly></v-text-field>
        </v-col>
        <v-col md="2">
          <v-text-field type="number" label="场地费税率(%)" v-model="placeUseContractItem.taxRate"
                        readonly></v-text-field>
        </v-col>
        <v-col md="2">
      ...
      <v-row>
        ...
        <v-dialog v-model="previewBillDialog" width="50%">
          <bill-preview :concat-id="placeUseContractItem.id"></bill-preview>
        </v-dialog>
      </v-row>
    </v-form>
  </v-container>
