            ...
            <v-container id="printc">
                <v-row class="border" justify="center">
                    ...
                    <v-col cols="12" style="min-height: 200px" class="border-b">
                        <table width="100%">
                            <caption class=" text-center">{{pay.payTypeTag}}</caption>
                            <tr>
                                <td class="border text-center" width="30%">供应单位</td>
                                <td class="border text-center" width="70%">{{pay.company.name}}</td>
                            </tr>
                            <tr>
                                <td class="border text-center" width="30%">本次申请付款金额</td>
                                <td class="border text-center" width="70%">{{pay.payMoney}}</td>
                            </tr>
                            <tr>
                                <td class="border text-center" width="30%">开户行</td>
                                <td class="border text-center" width="70%">{{pay.company.openAccount}}</td>
                            </tr>
                            <tr>
                                <td class="border text-center" width="30%">银行账号</td>
                                <td class="border text-center" width="70%">{{pay.company.bankNumber}}</td>
                            </tr>
                            <tr>
                                <td class="border text-center" width="30%">备注</td>
                                <td class="border text-center" width="70%">{{pay.remark}}</td>
                            </tr>
                        </table>
                    </v-col>
...
<script>
    import {getById} from "../../api/otherPay";
    ...
    export default {
        ...
        methods: {
            load(){
                getById(this.message.frameId).then(res => {
                    if (res.id == null) {
