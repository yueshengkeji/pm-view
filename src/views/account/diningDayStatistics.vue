...
<script>
    import {exportExcelDiningDayStatistics, getDiningDayStatistics} from '@/api/dining'

    export default {
        name: "day-statistics-account-list",
        data: () => ({
            loading: false,
            items: [],
            headers: [
                {text: '日期', value: 'ymd'},
                {text: '中餐|次数', value: 'countDay'},
        ...
        methods: {
            download(){
                ...
                if (q.startDate && q.endDate) {
                    ...
                    q.endDate += " 23:59:59"
                    exportExcelDiningDayStatistics(q).then(result=>{
            ...
            loadList() {
                ...
                getDiningDayStatistics(q).then((result) => {
