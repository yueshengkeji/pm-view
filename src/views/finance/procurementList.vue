...
export default {
  ...
  data: () => ({
    ...
    loading: false,
    headers: [
      {text: '序号', value: 'index', width: '70px',sortable:false},
      {text: '供应商', value: 'comName', width: '200px',sortable:false},
      ...
      {text: '误差', value: 'error',sortable:false},
      {text: '欠票情况', value: 'oweBillMoney'},
      {text: '会计科目', value: 'subjectSeries',sortable:false},
