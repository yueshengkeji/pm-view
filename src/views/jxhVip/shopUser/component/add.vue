  ...
  <v-container>
      <v-form ref="shopUserForm">
          ...
          <v-row>
              ...
              <v-col md="3">
                  <v-text-field v-model="shopUserItem.loginName" label="账号" :rules="rules.loginName" @change="checkSame"></v-text-field>
              </v-col>
              <v-col md="3">
...
import {insertShopUser,selectShopUserByName} from "@/api/jxhShopUser";
...
export default {
    ...
    methods:{
        ...
        submitAdd() {
            return insertShopUser(this.shopUserItem).then(res => {
                return res
            })
        },
        ...
        checkSame(){
            selectShopUserByName({loginName:this.shopUserItem.loginName}).then(res => {
                if (res == null){
                    this.sameFlag = true
                }else if(res != null){
                    this.sameFlag = false
