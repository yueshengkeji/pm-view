            ...
            <v-form ref="expressForm">
                <v-row align="center" class="pa-5" :style="{height: height+'px'}">
                    <v-col cols="12" align-self="center">
                        ...
                        <v-btn class="mt-1 mb-1" v-if="expressCode" block @click="reInit">重新扫码</v-btn>
                        <v-btn :disabled="(this.id == null && expressCode != '') || disabled"
                               :loading="loading"
                               block
                               color="primary"
...
<script>
    ...
    import {expressCode} from '@/api/procurement'
