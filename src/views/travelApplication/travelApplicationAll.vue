    ...
    export default {
        ...
        methods:{
            ...
            loadTravelApplication(){
                ...
                travelApplicationApi.getMonthTravelApplication({dateSearch:this.dateSearch,page:this.options.page,itemsPerPage:this.options.itemsPerPage,departmentId:departmentId}).then(result => {
                    if (result != null){
            ...
            exportExcel() {
                ...
                travelApplicationApi.exportTravelApplication({dateSearch:this.dateSearch,departmentId:departmentId}).then(result => {
