...
<script>
    import {insert} from "../../../../api/advertPlaceContract";
    ...
    export default {
        ...
        methods: {
            ...
            submitAdd() {
                return insert(this.advertPlaceContractItem).then(res => {
                    insertAdvertPlaceContractWordRecord(res)
